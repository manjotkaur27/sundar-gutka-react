...
const OfflineNotice = ({ compact, message }) => {
  const { card, mutedText } = useDashboardTheme();
  return (
    <View style={styles.wrap}>
      <View style={[card, styles.box, compact && styles.boxCompact]}>
...
OfflineNotice.propTypes = { compact: PropTypes.bool, message: PropTypes.string };
OfflineNotice.defaultProps = { compact: false, message: "" };
