...
const STRINGS = new LocalizedStrings({
  "en-US": {
    ...
    WIFI_ONLY_ALERT_BODY: "Downloads are set to Wi-Fi only. Connect to Wi-Fi or go to Settings → Audio to allow mobile data.",
    WIFI_ONLY_GO_SETTINGS: "Open Settings",
    MOBILE_DATA_ALERT_TITLE: "Using Mobile Data",
    MOBILE_DATA_ALERT_BODY: "You're about to download {title} ({size}) over mobile data. This may use your data plan.",
    MOBILE_DATA_DOWNLOAD_ANYWAY: "Download Anyway",
    CANCEL_DOWNLOAD_TITLE: "Cancel Download",
    CANCEL_DOWNLOAD_BODY: "Stop downloading {title}? Your progress will be lost.",
    CANCEL_DOWNLOAD_CONFIRM: "Stop Download",
    CANCEL_DOWNLOAD_KEEP: "Keep Downloading",
    DOWNLOAD_COMPLETE: "Download complete",
    DOWNLOAD_ALL: "Download all",
    REMOVE_DOWNLOAD_TITLE: "Remove download",
    REMOVE_DOWNLOAD_BODY: "Remove the downloaded {title} from this device?",
  ...
  hi: {
    ...
    WIFI_ONLY_ALERT_BODY: "डाउनलोड केवल Wi-Fi पर सेट हैं। Wi-Fi से जुड़ें या सेटिंग्स → ऑडियो में डेटा की अनुमति दें।",
    WIFI_ONLY_GO_SETTINGS: "सेटिंग्स खोलें",
    MOBILE_DATA_ALERT_TITLE: "मोबाइल डेटा का उपयोग",
    MOBILE_DATA_ALERT_BODY: "आप मोबाइल डेटा पर {title} ({size}) डाउनलोड करने वाले हैं।",
    MOBILE_DATA_DOWNLOAD_ANYWAY: "फिर भी डाउनलोड करें",
    CANCEL_DOWNLOAD_TITLE: "डाउनलोड रद्द करें",
    CANCEL_DOWNLOAD_BODY: "{title} का डाउनलोड रोकें? आपकी प्रगति मिट जाएगी।",
    ...
    REMOVE_DOWNLOAD_TITLE: "डाउनलोड हटाएँ",
    REMOVE_DOWNLOAD_BODY: "{title} का डाउनलोड इस डिवाइस से हटाएँ?",
  ...
  pa: {
    ...
    WIFI_ONLY_ALERT_BODY: "ਡਾਊਨਲੋਡ ਸਿਰਫ਼ Wi-Fi ਲਈ ਸੈੱਟ ਹਨ। Wi-Fi ਨਾਲ ਜੁੜੋ ਜਾਂ ਸੈਟਿੰਗਾਂ → ਆਡੀਓ ਵਿੱਚ ਮੋਬਾਇਲ ਡੇਟਾ ਦੀ ਆਗਿਆ ਦਿਓ।",
    WIFI_ONLY_GO_SETTINGS: "ਸੈਟਿੰਗਾਂ ਖੋਲੋ",
    MOBILE_DATA_ALERT_TITLE: "ਮੋਬਾਇਲ ਡੇਟਾ ਵਰਤੋਂ",
    MOBILE_DATA_ALERT_BODY: "ਤੁਸੀਂ ਮੋਬਾਇਲ ਡੇਟਾ 'ਤੇ {title} ({size}) ਡਾਊਨਲੋਡ ਕਰਨ ਵਾਲੇ ਹੋ।",
    MOBILE_DATA_DOWNLOAD_ANYWAY: "ਫਿਰ ਵੀ ਡਾਊਨਲੋਡ ਕਰੋ",
    CANCEL_DOWNLOAD_TITLE: "ਡਾਊਨਲੋਡ ਰੱਦ ਕਰੋ",
    CANCEL_DOWNLOAD_BODY: "{title} ਦਾ ਡਾਊਨਲੋਡ ਰੋਕਣਾ ਹੈ? ਤੁਹਾਡੀ ਤਰੱਕੀ ਖਤਮ ਹੋ ਜਾਵੇਗੀ।",
    ...
    REMOVE_DOWNLOAD_TITLE: "ਡਾਊਨਲੋਡ ਹਟਾਓ",
    REMOVE_DOWNLOAD_BODY: "{title} ਦਾ ਡਾਊਨਲੋਡ ਇਸ ਡੀਵਾਈਸ ਤੋਂ ਹਟਾਉਣਾ ਹੈ?",
  ...
  fr: {
    ...
    WIFI_ONLY_ALERT_BODY: "Les téléchargements sont réglés sur Wi-Fi uniquement. Connectez-vous au Wi-Fi ou allez dans Réglages → Audio pour autoriser les données mobiles.",
    WIFI_ONLY_GO_SETTINGS: "Ouvrir les réglages",
    MOBILE_DATA_ALERT_TITLE: "Utilisation des données mobiles",
    MOBILE_DATA_ALERT_BODY: "Vous êtes sur le point de télécharger {title} ({size}) via les données mobiles.",
    MOBILE_DATA_DOWNLOAD_ANYWAY: "Télécharger quand même",
    CANCEL_DOWNLOAD_TITLE: "Annuler le téléchargement",
    CANCEL_DOWNLOAD_BODY: "Arrêter le téléchargement de {title} ? Votre progression sera perdue.",
    CANCEL_DOWNLOAD_CONFIRM: "Arrêter le téléchargement",
    CANCEL_DOWNLOAD_KEEP: "Continuer le téléchargement",
    DOWNLOAD_COMPLETE: "Téléchargement terminé",
    DOWNLOAD_ALL: "Tout télécharger",
    REMOVE_DOWNLOAD_TITLE: "Supprimer le téléchargement",
    REMOVE_DOWNLOAD_BODY: "Supprimer {title} téléchargé de cet appareil ?",
  ...
  it: {
    ...
    WIFI_ONLY_ALERT_BODY: "I download sono impostati solo su Wi-Fi. Connettiti al Wi-Fi o vai su Impostazioni → Audio per consentire i dati mobili.",
    WIFI_ONLY_GO_SETTINGS: "Apri impostazioni",
    MOBILE_DATA_ALERT_TITLE: "Utilizzo dati mobili",
    MOBILE_DATA_ALERT_BODY: "Stai per scaricare {title} ({size}) tramite dati mobili.",
    MOBILE_DATA_DOWNLOAD_ANYWAY: "Scarica comunque",
    CANCEL_DOWNLOAD_TITLE: "Annulla download",
    CANCEL_DOWNLOAD_BODY: "Interrompere il download di {title}? I progressi andranno persi.",
    CANCEL_DOWNLOAD_CONFIRM: "Interrompi download",
    CANCEL_DOWNLOAD_KEEP: "Continua download",
    DOWNLOAD_COMPLETE: "Download completato",
    DOWNLOAD_ALL: "Scarica tutto",
    REMOVE_DOWNLOAD_TITLE: "Rimuovi download",
    REMOVE_DOWNLOAD_BODY: "Rimuovere {title} scaricato da questo dispositivo?",
  ...
  es: {
    ...
    WIFI_ONLY_ALERT_TITLE: "Solo Wi-Fi",
    WIFI_ONLY_ALERT_BODY: "Las descargas están configuradas para Wi-Fi únicamente. Conéctate a Wi-Fi o ve a Ajustes → Audio para permitir datos móviles.",
    WIFI_ONLY_GO_SETTINGS: "Abrir ajustes",
    MOBILE_DATA_ALERT_TITLE: "Usando datos móviles",
    MOBILE_DATA_ALERT_BODY: "Estás a punto de descargar {title} ({size}) usando datos móviles.",
    MOBILE_DATA_DOWNLOAD_ANYWAY: "Descargar de todas formas",
    CANCEL_DOWNLOAD_TITLE: "Cancelar descarga",
    CANCEL_DOWNLOAD_BODY: "¿Detener la descarga de {title}? Perderás el progreso.",
    CANCEL_DOWNLOAD_CONFIRM: "Detener descarga",
    CANCEL_DOWNLOAD_KEEP: "Seguir descargando",
    DOWNLOAD_COMPLETE: "Descarga completada",
    DOWNLOAD_ALL: "Descargar todo",
    REMOVE_DOWNLOAD_TITLE: "Eliminar descarga",
    REMOVE_DOWNLOAD_BODY: "¿Eliminar {title} descargado de este dispositivo?",
