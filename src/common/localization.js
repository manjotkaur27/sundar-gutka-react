...
const STRINGS = new LocalizedStrings({
  "en-US": {
    ...
    CANCEL_DOWNLOAD_BODY: "Cancel downloading {title}?",
  },
  hi: {
    about: "हमारे बारे",
    ...
    CANCEL_DOWNLOAD_BODY: "{title} डाउनलोड रद्द करें?",
  },
  ...
  pa: {
    ...
    CANCEL_DOWNLOAD_BODY: "{title} ਡਾਊਨਲੋਡ ਰੱਦ ਕਰੋ?",
  },
  fr: {
    about: "Infos",
    ...
    CANCEL_DOWNLOAD_BODY: "Annuler le téléchargement de {title} ?",
  },
  it: {
    about: "Info",
    ...
    CANCEL_DOWNLOAD_BODY: "Annullare il download di {title}?",
  },
  es: {
    ...
    CANCEL_DOWNLOAD_BODY: "¿Cancelar la descarga de {title}?",
  },
});
