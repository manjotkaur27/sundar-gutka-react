...
export const createCommonMock = (overrides = {}) => {
  ...
  return {
    ...
    COACH: { HOME: "home", AUDIO_HINT: "audioHint", PREVIEW: "preview", PLAYER: "player", EXPLORE: "explore", MANAGE_SETTINGS: "manageSettings", DOWNLOADS: "downloads" },
    useCoachmark: () => ({ shouldShow: false }),
    actions: {
